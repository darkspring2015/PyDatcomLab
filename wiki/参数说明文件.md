...
| ------ | :----: | :---------: | ---- | -------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
|        |   TR   | TR 效应分析 |      |          | 升力过渡旗引起的阻力，用于机翼结构的回归分析<br /> =0.0表示没有过渡，默认情况下<br /> =1.0为全尺寸飞行过渡带y> | drag due to lift transition flag, for regression analysis of wing-body configuration  <br />= 0.0 for no transition ,default<br />= 1.0 for transition strips of full scale flight |
|        |        |             |      |          |                                                              |                                                              |
|        |        |             |      |          |                                                              |                                                              |
|        |        |             |      |          |                                                              |                                                              |
|        |        |             |      |          |                                                              |                                                              |
