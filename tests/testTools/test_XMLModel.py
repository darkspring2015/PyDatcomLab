...
sys.path.append(os.path.abspath(os.path.join('.', 'PyDatcomLab', 'GUIs', 'tools')))
...
from PyDatcomLab.GUIs.tools.XMLModel import  XMLModel as X
from PyQt5 import  QtWidgets



class XMLModel_Test(unittest.TestCase):    
    def setUp(self):
        self.tClass = X
    def tearDown(self):
        self.tClass = None
