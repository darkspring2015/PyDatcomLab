...
class BODY_Test(unittest.TestCase):    
    ...
    def test_Model(self):
        ...
        dM.setDoc(tDoc) 
        dM.setNamelist(self.tClassName, 'ZB'    , 9)        
        dM.setNamelist(self.tClassName, 'SREF'  , 5.0)
        dM.setNamelist(self.tClassName, 'BLF'   ,'.TRUE.' )
        dM.setNamelist(self.tClassName, 'ROUNDN','.FALSE.')
