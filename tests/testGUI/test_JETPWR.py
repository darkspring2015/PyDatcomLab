...
from PyDatcomLab.GUIs.PlaneConfiguration import  JETPWR as O
from PyDatcomLab.Core import datcomDefine as Df , dcModel as pm
from PyQt5 import  QtWidgets
class BODY_Test(unittest.TestCase):    
    def setUp(self):
        self.tClass = O.JETPWR
        self.tClassName = 'JETPWR'
    def tearDown(self):
        self.tClass = None
    def testRuning(self):
    ...
    def test_Model(self):
        ...
        dM.setDoc(tDoc) 
        dM.setNamelist(self.tClassName, 'AIETLJ', 10)
        dM.setNamelist(self.tClassName, 'NENGSJ', 2)
        dM.setNamelist(self.tClassName, 'THSTCJ', 1.4)
        dM.setNamelist(self.tClassName, 'JIALOC', 2.1)
        dM.setNamelist(self.tClassName, 'JEVLOC', 2.2)
