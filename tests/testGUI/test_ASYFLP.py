...
from PyDatcomLab.GUIs.PlaneConfiguration import  ASYFLP as O
from PyDatcomLab.Core import datcomDefine as Df , dcModel as pm
from PyQt5 import  QtWidgets
class BODY_Test(unittest.TestCase):    
    def setUp(self):
        self.tClass = O.ASYFLP
        self.tClassName = 'ASYFLP'
    def tearDown(self):
        self.tClass = None
    def testRuning(self):
    ...
    def test_Model(self):
        ...
        dM.setDoc(tDoc) 
        dM.setNamelist(self.tClassName, 'NDELTA', 9)        
        dM.setNamelist(self.tClassName, 'STYPE', '5.0')
        dM.setNamelist(self.tClassName, 'DELTAL',[1, 2, 3, 4, 5, 6, 7, 8, 9]  , 1)
        dM.setNamelist(self.tClassName, 'DELTAR',[1, 2, 3, 4, 5, 6, 7, 8, 9]  , 1)
