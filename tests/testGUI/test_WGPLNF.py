...
class BODY_Test(unittest.TestCase):    
    ...
    def test_Model(self):
        ...
        self.assertEqual(tDoc['WGPLNF']['CHRDTP']
                       , tDoc2.getNamelistVar('WGPLNF','CHRDTP'))
