...
from PyDatcomLab.GUIs.PlaneConfiguration.HTSCHR import  HTSCHR as O
...
class BODY_Test(unittest.TestCase):    
    ...
    def test_Model(self):
        ...
        self.assertEqual(pmObj2.getNamelistVar(self.namlist,'TOVC')
                       , tDoc2.getNamelistVar(self.namlist,'TOVC'))
