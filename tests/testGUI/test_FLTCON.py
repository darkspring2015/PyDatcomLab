...
from PyDatcomLab.GUIs.PlaneConfiguration import  FLTCON as O
from PyDatcomLab.Core import datcomDefine as Df , dcModel as pm
from PyQt5 import  QtWidgets
class FLTCON_Test(unittest.TestCase):    
    def setUp(self):
        self.tClass = O.FLTCON
    def tearDown(self):
        self.tClass = None
    def testRuning(self):
    ...
    def test_Model(self):
        ...
        self.assertEqual(tDoc['FLTCON']['ALSCHD']['Value']
                       , tDoc2.getNamelistVar('FLTCON','ALSCHD')['Value'])
