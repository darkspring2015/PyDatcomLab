...
from PyDatcomLab.GUIs.PlaneConfiguration.EXPR import  EXPR as O
...
class BODY_Test(unittest.TestCase):    
    ...
    def test_Model(self):
        ...
        self.assertEqual(pmObj2.getNamelistVar(self.namlist,'CDV')
                       , tDoc2.getNamelistVar(self.namlist,'CDV'))
