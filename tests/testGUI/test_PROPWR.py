...
class BODY_Test(unittest.TestCase):    
    ...
    def test_Model(self):
        ...
        self.assertEqual(tDoc['PROPWR']['AIETLP']
                       , tDoc2.getNamelistVar('PROPWR','AIETLP'))
