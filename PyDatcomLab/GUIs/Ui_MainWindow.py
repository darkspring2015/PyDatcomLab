...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/mainwindow/images/mainwindow/analsyeGuide.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.menu_8.setIcon(icon)
        self.menu_8.setObjectName("menu_8")
        self.menu_7 = QtWidgets.QMenu(self.menu_Analyze)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/mainwindow/images/mainwindow/imglayout.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.menu_7.setIcon(icon1)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/mainwindow/images/mainwindow/docs.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionDocs.setIcon(icon2)
        self.actionDocs.setObjectName("actionDocs")
        self.actionHelp = QtWidgets.QAction(MainWindow)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/mainwindow/images/mainwindow/help.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionHelp.setIcon(icon3)
        self.actionHelp.setObjectName("actionHelp")
        self.actionAbout = QtWidgets.QAction(MainWindow)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/mainwindow/images/mainwindow/BostenAI.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.actionDtcomDefineEditer.setIcon(icon2)
