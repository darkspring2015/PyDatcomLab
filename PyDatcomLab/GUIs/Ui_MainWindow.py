...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon29 = QtGui.QIcon()
        icon29.addPixmap(QtGui.QPixmap(":/icos/icons.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon31 = QtGui.QIcon()
        icon31.addPixmap(QtGui.QPixmap(":/icos/documentNewView.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
