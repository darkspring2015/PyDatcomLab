...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icos/dirOpen.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_ChoiseDirectory.setIcon(icon)
        ...
        self.layoutWidget2.setGeometry(QtCore.QRect(110, 290, 204, 25))
        ...
        self.widget.setGeometry(QtCore.QRect(50, 140, 391, 81))
        ...
        self.prjDescribe = QtWidgets.QTextEdit(self.widget)
