...
# Form implementation generated from reading ui file 'E:\Projects\PyDatcomLab\PyDatcomLab\GUIs\PlaneConfiguration\OPTIONS.ui'
#
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "附加参数"))
        self.checkBox_ROUGFC.setText(_translate("Form", "ROUGFC 表面粗糙度"))
        self.checkBox_SREF.setText(_translate("Form", "SREF 参考面积"))
        self.checkBox_CBARR.setText(_translate("Form", "CBARR 纵向参考长度值"))
        self.checkBox_BLREF.setText(_translate("Form", "BLREF 横向参考长度值"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("Form", "粗糙度"))
